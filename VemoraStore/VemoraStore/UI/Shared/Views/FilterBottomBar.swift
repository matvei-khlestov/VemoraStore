...
/// Компонент `FilterBottomBar`.
///
/// Отвечает за:
/// - показ итоговой строки с количеством найденных товаров;
/// - кнопку применения фильтров;
/// - тень и скругление верхней панели.
///
/// Структура UI:
/// - контейнер `UIView` со скруглением и тенью;
/// - `UILabel` с текстом результата;
/// - `UIButton` в стиле капсулы.
///
/// Публичный API:
/// - `onApply` — колбэк на нажатие кнопки;
/// - `set(count:hasActiveFilters:)` — обновление текста/кнопки.
///
/// Используется:
/// - на экране фильтра каталога, в нижней фиксированной зоне.
