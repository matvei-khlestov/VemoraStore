...
/// Контроллер `OrderSuccessViewController` для экрана успешного оформления.
///
/// Отвечает за:
...
/// - минимальную навигацию (скрытие навбара на экране).
///
/// Взаимодействует с:
/// - колбэком `onViewCatalog` для маршрутизации назад в каталог.
///
/// Особенности:
/// - чистый UI-контроллер без бизнес-логики;
/// - верстка через вертикальные `UIStackView` с аккуратными отступами;
