...
/// Переключает между экранами **входа** и **регистрации** с кросс-фейдом,
/// прокидывает коллбэки (назад, «забыл пароль», политика конфиденциальности)
/// и синхронизирует заголовок навигации с текущим режимом.
