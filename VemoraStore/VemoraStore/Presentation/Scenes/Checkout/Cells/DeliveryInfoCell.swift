...
/// для отображения информации о доставке.
///
/// Содержит:
/// - заголовок с типом доставки ("Доставка Vemora Store");
/// - дату или срок доставки (`whenLabel`);
/// - стоимость доставки (`costLabel`, выделена зелёным цветом);
///
/// Используется при выборе способа доставки **курьером**.
