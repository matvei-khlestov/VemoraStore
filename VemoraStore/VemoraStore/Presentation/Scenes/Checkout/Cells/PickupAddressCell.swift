...
/// для отображения адреса пункта самовывоза.
///
/// Содержит:
/// - иконку магазина (`storefront.fill`);
/// - текст адреса самовывоза;
///
/// Используется, когда пользователь выбирает способ доставки **самовывоз**.
