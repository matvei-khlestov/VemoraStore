...
/// Ячейка `CapsuleTagCell` для списка тегов/фильтров.
///
/// Основные задачи:
/// - Показывает круглую иконку и заголовок тега в капсуле;
/// - Поддерживает выделение: меняет фон, бордер и цвет текста;
/// - Загружает иконку по URL через Kingfisher.
///
/// Особенности:
/// - Self-sizing ширины, фиксированный минимум по высоте;
/// - Капсула с бордером, плавное переключение состояний;
/// - Сброс загрузки и состояния в `prepareForReuse`;
/// - Доступность: корректные `accessibilityLabel` и `traits`.
