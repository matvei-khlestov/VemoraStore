...
/// Ячейка `CategoryCell` для витрины категорий.
///
/// Основные задачи:
/// - Показывает круглое изображение категории, название и подзаголовок;
/// - Отображает количество товаров в категории (`"N Products"`);
/// - Загружает картинку по URL через хелпер `loadImage(from:)`
///   (c фолбэком-заглушкой).
///
/// Особенности:
/// - Круглый аватар (cornerRadius = imageSide / 2);
/// - Центрированная верстка на Auto Layout;
/// - Адаптивные отступы и шрифты для лаконичной карточки.
...
final class CategoryCell: UICollectionViewCell {
    ...
    func configure(category: Category, count: Int) {
        ...
        subtitleLabel.text = "\(count) товаров"
